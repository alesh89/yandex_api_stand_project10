...
```
После описания данных фукнций расписаны тесты, позволяющие выполнить првоерки по каждому пункту чек-листа. Каждый новый тест начинается с префикса test_.
