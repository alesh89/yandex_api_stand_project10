...
```
После описания данных функций расписаны тесты, позволяющие выполнить проверки по каждому пункту чек-листа. Каждый новый тест начинается с префикса test_ и в нем применяется та или иная функция, в зависимости от позитивности проверки..
